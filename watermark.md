...
Not only is this method supposed to hide the watermark seemlessly, it is also said in the original article that it is robust to pruning and overwriting. Let's test it!</p>
